...
const translations = {
  id: {
    ...
    commentAccess: 'PIC, Peninjau, dan Pengawas dapat berdiskusi pada setiap riwayat progres.', noUpdates: 'Belum ada pembaruan tambahan.', printHistory: 'Cetak', projectHistory: 'Riwayat proyek', printPreview: 'Pratinjau cetak', generatedOn: 'Dibuat pada', projectDetails: 'Detail proyek', historyEntries: 'Riwayat progres', workers: 'Pekerja', created: 'Dibuat',
  ...
  en: {
    ...
    commentAccess: 'PICs, the Reviewer, and Overseers can discuss each progress entry.', noUpdates: 'No additional updates yet.', printHistory: 'Print', projectHistory: 'Project history', printPreview: 'Print preview', generatedOn: 'Generated on', projectDetails: 'Project details', historyEntries: 'Progress history', workers: 'Workers', created: 'Created',
